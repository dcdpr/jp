...
pub use crate::log_layer::ProtocolLogHandle;
use crate::{client::SharedWriter, log_layer::ProtocolLogLayer};
...
///
/// A `describe` is answered and ends the session; an `init` starts the web
/// server and blocks until the host asks it to stop.
pub fn run(
...
/// known.
#[must_use]
pub fn init_tracing() -> ProtocolLogHandle {
