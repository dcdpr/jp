...
/// Once the chooser has been fetched that is the key of the first assignment
/// row, so on a touch device opening the dialog raises the keyboard over it and
/// iOS zooms the page to meet the field.
#[test]
