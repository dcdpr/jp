...
const AUTH_KEY: &str = "providers.llm.deepseek.auth";
...
pub struct DeepseekConfig {
    ...
    ///
    /// Deepseek has no subscription plan JP can authenticate against, so a
    ...
    ///
    /// ```toml
    /// api_key_env = { work = "WORK_DEEPSEEK_KEY", personal = "MY_DEEPSEEK_KEY" }
    /// ```
...
impl Validator for DeepseekConfig {
...
impl FillDefaults for PartialDeepseekConfig {
