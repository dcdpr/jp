...
/// Where a call's correlation key travels on its MCP request when JP submits
/// it itself.
///
...
impl TerminalExecutorSource {
    ...
    /// that reads vendor hints there. It changes no execution policy.
    #[expect(
        clippy::too_many_arguments,
        reason = "Every argument is a distinct binding fixed for the endpoint's lifetime"
    )]
