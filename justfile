...
#   just ticket-list --label config         # one area of the system
...
#
#   just ticket-label T-02wt0kx --label config --label cli
...
ticket-labels-sync:
...

    {
        ...
        echo '# and one left here after being retired is refused with a message naming the'
        ...
        for tool in ticket_create ticket_label ticket_list; do
            echo
